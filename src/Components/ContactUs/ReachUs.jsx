...
import map from '../../assets/ContactUsiamges/mapimage.png'; // Import the map image
  ...
  return (
    <div>
      ...
      <div className="m-10 flex justify-center">
        <img src={map} alt="Map" className="w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] max-w-[1240px] h-auto" />
      </div>
    </div>
  );
};
